  ...
  return (
    <Document>
      ...
      <Page size="A4" style={s.page}>
        <View style={s.header}>
          <Text style={s.title}>GSTSaathi ITC Analysis Report</Text>
        ...
        <Text style={s.watermark}>This report is auto-generated by GSTSaathi. Consult your CA before filing.</Text>
        <View style={s.footer}>
          <Text>GSTSaathi • gstsaathi.com</Text>
          <Text>Page 1</Text>
        </View>
      </Page>
